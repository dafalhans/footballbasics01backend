...
import com.hans.backend.backend.appl.countries.resttemplate.service.service.CountryRestService;
...
//        trainerdto1.setBirthDate("31/07/1985");
        ...
        trainerdto2.setTrainerSpecialty("LEAD");
...
//        trainerdto5.setBirthDate("31/07/1985");
        ...
        // Begin - Teams
        TeamService teamSrv = (TeamService) ctx.getBean(TeamService.class);
        Team teamdto1 = new Team();
        String teamdto1Id = teamSrv.create(teamdto1).getId();
        teamdto1 = teamSrv.getById(Long.valueOf(teamdto1Id));
//        teamdto1.setPlayerBasicList(List.of(playerdto1,playerdto2));
        teamdto1.setPlayers(List.of(playerdto1,playerdto2));
        teamdto1.setTrainer(trainerSrv.getById(Long.valueOf(trainerdto1Id)));
        teamdto1.setName("Arsenal");
        teamdto1.setTeamName("Arsenal");
        teamdto1.setLocation("London (Holloway)");
        teamdto1.setStadiumName("Emirates Stadium");
        teamdto1 = imageService.addTeamImage(teamdto1, teamdto1.getTeamName());
        teamSrv.update(teamdto1);
        
        Team teamdto2 = new Team();
        String teamdto2Id = teamSrv.create(teamdto2).getId();
        teamdto2 = teamSrv.getById(Long.valueOf(teamdto2Id));
        teamdto2.setPlayers(List.of(playerdto3,playerdto5));
        teamdto2.setTrainer(trainerSrv.getById(Long.valueOf(trainerdto2Id)));
        teamdto2.setName("Liverpool");
        teamdto2.setTeamName("Liverpool");
        teamdto2.setLocation("Liverpool (Anfield)");
        teamdto2.setStadiumName("Anfield");
        teamdto2 = imageService.addTeamImage(teamdto2, teamdto2.getTeamName());
        teamSrv.update(teamdto2);

//        teamdto1.setTeamLogoImageData();
        ...
        // Country Rest Service (als SOAP service http://webservices.oorsprong.org/ down is)

//        CountryRestService countryRestService = (CountryRestService) ctx.getBean(CountryRestService.class);
//        countryRestService.printUrl();
////        countryRestService.getById("BEL");
//
//        countryRestService.getByIdLogger("BEL");
